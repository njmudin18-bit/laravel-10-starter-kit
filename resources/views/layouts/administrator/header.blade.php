        ...
        <div class="header-content">
                    ...
                    <li class="menu-content ps-menu">
                        <a href="#">
                            <div class="message-image">
                                <img src="{{ asset('assetsXX/images/avatar1.png') }}" class="rounded-circle w-100"
                                    alt="user1">
                            </div>
                        ...
                        <a href="#">
                            <div class="message-image">
                                <img src="{{ asset('assetsXX/images/avatar2.png') }}" class="rounded-circle w-100"
                                    alt="user1">
                            </div>
            ...
            <div class="dropdown dropdown-menu-end">
                <a href="#" class="user-dropdown" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <img class="img-user" src="{{ asset('assetsXX/images/avatar1.png') }}" alt="user"srcset="">
                </a>
