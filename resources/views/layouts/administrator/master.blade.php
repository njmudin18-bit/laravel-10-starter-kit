...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assetsXX/css/style.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assetsXX/css/bootstrap-override.min.css') }}">
    <link rel="stylesheet" id="theme-color" href="{{ asset('assetsXX/css/dark.min.css') }}">
...
<body>
    ...
    <script src="{{ asset('assetsXX/js/main.min.js') }}"></script>
