                    ...
                    <form method="POST" action="{{ route('users.update', $user->id) }}" enctype="multipart/form-data">
                      ...
                      <div class="row mt-2">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('no_hp') is-invalid @enderror" id="no_hp" name="no_hp" value="{{ old('no_hp', $user->profile->no_hp) }}" @required(true)>
                            @error('no_hp')
                              <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                          </div>
                      ...
                      <div class="row mt-2">
                        <div class="col-md-6">
                          ...
                          <input class="form-control @error('tanggal_lahir') is-invalid @enderror" type="date" autocomplete="off" id="tanggal_lahir" name="tanggal_lahir" value="{{ old('tanggal_lahir', $user->profile->tanggal_lahir) }}" @required(true)>
                          @error('tanggal_lahir')
                            <div class="invalid-feedback">{{ $message }}</div>
                          @enderror
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <select class="form-select select2 @error('jenis_kelamin') is-invalid @enderror" id="jenis_kelamin" name="jenis_kelamin" @required(true)>
                              <option value=""></option>
                              <option {{ $user->profile->jenis_kelamin == 'laki-laki' ? 'selected' : '' }} value="laki-laki" {{ old('jenis_kelamin') == 'laki-laki' ? 'selected' : '' }}>
                                Laki-laki
                              </option>
                              <option {{ $user->jenis_kelamin == 'perempuan' ? 'selected' : '' }} value="perempuan" {{ old('jenis_kelamin') == 'perempuan' ? 'selected' : '' }}>
                                Perempuan
                              </option>
                            </select>
                            @error('jenis_kelamin')
                        ...
                        <div class="col-md-2">
                          <div class="form-group">
                            @if ($user->profile->image)
                              <img src="{{ asset('assets/images/users/' . $user->profile->image) }}" alt="Gambar Pengguna" class="img-thumbnail" width="60">
                            @endif
                          </div>
                        </div>
                      </div>
